...
public class Physics4 extends ApplicationAdapter {
	...
	public void create() {
		...
		sprite.setPosition(-sprite.getWidth()/2,-sprite.getHeight()/2 +280);
		sprite2 = new Sprite(img);
		//made sprite 2 more toward the right to show the collision better
		sprite2.setPosition(-sprite2.getWidth()/2 +100 ,-sprite2.getHeight()/2);
		...
		//removing them as a WORLD_ENTITY allows them to interact
